...
NSArray *BNRHierarchyForClass (Class cls){
    // Declare an array to hold the list of this class
    // and all its superclasses, building a hierarchy
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        // Create an array of dictionaries, where each dictionary will end up
